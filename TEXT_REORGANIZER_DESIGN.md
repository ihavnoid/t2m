...
```html
<li><a href="#" id="ai-paste-text"><i class="fa-solid fa-wand-magic-sparkles"></i> Paste Raw Text...</a></li>
```
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <textarea id="ai-paste-input" placeholder="Paste your raw notes here..."></textarea>
                <div id="ai-status">Ready</div>
            </div>
            <div class="modal-footer">
                <button id="ai-process-btn" class="button">Process & Paste</button>
            </div>
        </div>
    </div>
</div>
