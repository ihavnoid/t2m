...
describe("TextReorganizer Heuristic (detectDepth)", () => {
    ...
    it("1-5: Basic Indentation", () => {
        ...
        expect(
            textReorganizer.detectDepth("    Child", "Root", 0, context),
        ).toBe(1);
        expect(
    ...
    it("6-10: Bullets", () => {
        expect(textReorganizer.detectDepth("- Item 1", null, 0, context)).toBe(
            0,
        );
        expect(
    ...
    it("11-15: Numbering", () => {
        expect(textReorganizer.detectDepth("1. First", null, 0, context)).toBe(
            0,
        );
        expect(
    ...
    it("16-20: Colons", () => {
        expect(textReorganizer.detectDepth("Header:", null, 0, context)).toBe(
            0,
        );
        expect(
            textReorganizer.detectDepth("Detail", "Header:", 0, context),
        ).toBe(1);
        expect(
    ...
    it("31-40: Mixed whitespace", () => {
        expect(textReorganizer.detectDepth("\tTabbed", null, 0, context)).toBe(
            1,
        );
        expect(
