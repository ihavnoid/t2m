...
describe('Project Smoke Test (Import Graph Validation)', () => {
    ...
    beforeAll(() => {
        // 1. Setup a basic DOM
        const dom = new JSDOM('<!DOCTYPE html><html><body><div id="textedit"></div><div id="textedit_message"></div><div id="stageHolder"></div></body></html>');
    ...
    it('should be able to initialize the MindmapEngine class', async () => {
        ...
        const engine = mindmap.createEngine('stageHolder', { width: 400, height: 400 });
