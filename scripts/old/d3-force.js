...
!(function (n, t) {
    ...
    ((n.forceCenter = function (n, t) {
            ...
            function y() {
                if (nodes) {
                    var t,
                        i,
                        u = nodes.length;
                    for (radii = new Array(u), t = 0; t < u; ++t)
                        ((i = nodes[t]),
                            (radii[i.index] = radius_value(i, t, nodes)));
                }
            }
            return (
                "function" != typeof radius_value &&
                    (radius_value = i(
                        null == radius_value ? 1 : +radius_value,
                    )),
                (force.initialize = function (n, t) {
                    ((nodes = n), (a = t), y());
                }),
                ...
                (force.radius = function (t) {
                    return arguments.length
                        ? ((radius_value = "function" == typeof t ? t : i(+t)),
                          y(),
                          force)
                        : radius_value;
                }),
        ...
        (n.forceLink = function (n) {
            var t,
                ...
                v = function (n) {
                    return (
                        1 /
                        Math.min(count[n.source.index], count[n.target.index])
                    );
                },
                y = fff(30),
                d = 1;
            ...
            function force(alpha) {
                ...
                function links_intersect(link1, link2) {
                    ...
                    let v1 =
                        intersect_eq(link1.source.x, link1.source.y, link2) *
                            intersect_eq(
                                link1.target.x,
                                link1.target.y,
                                link2,
                        ...
                        0;
                    let v2 =
                        intersect_eq(link2.source.x, link2.source.y, link1) *
                            intersect_eq(
                                link2.target.x,
                                link2.target.y,
                                link1,
            ...
            function x() {
                if (r) {
                    ...
                    for (i = 0, count = new Array(a); i < l; ++i)
                        (((u = n[i]).index = i),
                            "object" != typeof u.source &&
                                (u.source = c(v, u.source)),
                            "object" != typeof u.target &&
                                (u.target = c(v, u.target)),
                            (count[u.source.index] =
                                (count[u.source.index] || 0) + 1),
                            (count[u.target.index] =
                                (count[u.target.index] || 0) + 1));
                    for (i = 0, bias = new Array(l); i < l; ++i)
                        ((u = n[i]),
                            (bias[i] =
                                count[u.source.index] /
                                (count[u.source.index] +
        ...
        (n.forceManyBody = function () {
            ...
            function g() {
                if (n) {
                    ...
                    for (f = new Array(r), t = 0; t < r; ++t)
                        ((e = n[t]), (f[e.index] = +strengthVal(e, t, n)));
                }
            }
            ...
            return (
                ...
                (d.strength = function (n) {
                    return arguments.length
                        ? ((strengthVal = "function" == typeof n ? n : fff(+n)),
                          g(),
                          d)
                        : strengthVal;
                }),
                (d.distanceMin = function (n) {
                    return arguments.length
                        ? ((distanceMinVal = n * n), d)
                        : Math.sqrt(distanceMinVal);
                }),
                (d.distanceMax = function (n) {
                    return arguments.length
                        ? ((distanceMaxVal = n * n), d)
                        : Math.sqrt(distanceMaxVal);
                }),
                (d.theta = function (n) {
                    return arguments.length
                        ? ((thetaVal = n * n), d)
        ...
        (n.forceRadial = function (radiusVal, t, e) {
            ...
            return (
                "function" != typeof radiusVal && (radiusVal = i(+radiusVal)),
                null == t && (t = 0),
                null == e && (e = 0),
                ...
                (a.strength = function (n) {
                    return arguments.length
                        ? ((strengthVal = "function" == typeof n ? n : i(+n)),
                          c(),
                          a)
                        : strengthVal;
                }),
                (a.radius = function (t) {
                    return arguments.length
                        ? ((radiusVal = "function" == typeof t ? t : i(+t)),
                          c(),
                          a)
                        : radiusVal;
                }),
