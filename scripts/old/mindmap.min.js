        ...
        return that = {
            ...
            runSimulation: function() {
                ...
                var linkLength = (link, index) => {
                    ...
                    let w = (sn.w + dn.w) / 2
                    let h = (sn.h + dn.h) / 2
                    return Math.max( Math.sqrt(w*w + h*h), (sn.parent_dim + dn.parent_dim)/12)
                }
                if(d.nodes.length > 0) {
...
*/
            ...
            setStartPosition: function(a, id) {
                if (!1 == a.data.parent) {
                    let r = Math.sqrt(id) * 100;
                    let rval = Math.random();
                    return a.x = r * rval, a.y = r * Math.sqrt(1-rval * rval), a.px = a.x, a.py = a.y, a;
                }
                a.x = a.data.parent.x;
                a.y = a.data.parent.y;
            ...
            text2mindmap: function(a) {
                ...
                d.nodes.forEach(function(a, b) {
                    ...
                    if(a.data.parent && !that.isLinkedTo(a, a.data.parent)) {
                        ...
                        // if we added a link, all links sharing the same parent will have its distance reset
                        d.links.forEach( (x) => {
                            if(x.target == a.data.parent) {
                                delete x.distance
                            }
                        });
                ...
                d.nodes.forEach(function(a, b) {
                    "undefined" == typeof a.x && that.setStartPosition(a, b)
                });
                y = b
