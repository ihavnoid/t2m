        ...
        editorPane.on("keydown", function(a) {
            ...
            if (a.ctrlKey && 219 == a.which) {
                ...
                for(var i=nb; i<= ne; i++) {
                    ...
                    n.fixed = false;
                    editorPane.updateTextForCoordinates(i, n.fixed, n.x, n.y);
                }
            }
...
*/
            ...
            newGroup: function(a) {
                ...
                if(a.data.comment != "") { // && that.settings("scale") * a.data.fontSize > 16) {
                    ...
                    var width = Math.max(c.getWidth(), cc.getWidth()) + a.data.fontSize/8;
                    ...
                    var width = c.getWidth() + a.data.fontSize / 8;
                ...
                b.on("mouseover", function() {
                    ...
                    editorPane.moveCursorToNode(d.nodes.indexOf(a));
                });
            ...
            text2mindmap: function(a) {
                ...
                y = b
                updatedRate = (modifiedNodes + addedNodes + removedNodes - 5) / (d.nodes.length + 1e-6);
                return true
            },
            setTheme: function(a) {
                a.font = e.font;
