...
//        });
    ...
    var I = function(q, r) {
        ...
        return that = {
            ...
            settings: function(a, g, c) {
                ...
                if ("object" == typeof a) {
                    ...
                    if ("undefined" != typeof a.lockAfterMoving) {
                        e.lockAfterMoving = a.lockAfterMoving;
                    }
            ...
            // the purpose of size_scale is to gradually grow the individual node sizes,
            // so that they can first get into place where it isn't too tangled.
            // the children's area isn't going to get scaled because the purpose
            // of the children's area is to make sure we have enough empty space for the child nodes.
...
*/
            ...
            newGroup: function(a, selected) {
                ...
                b.on("touchstart mousedown", function(b) {
                    ...
                    a.fixedtemp = a.fixed || e.lockAfterMoving;
                    a.fixed = true;
