    ...
    var I = function(q, r) {
        ...
        return that = {
            ...
            execute: function(a, g) {
                ...
                f ? f.start() : f = d3.layout.force().linkDistance(e.linkLength).charge(-e.charge).friction(e.friction).theta(0.99).gravity(e.gravity).size([1e-6,1e-6]).nodes(d.nodes).links(d.links).start().on("tick", function() {
                    var a =
                        f.alpha();
...
*/
            ...
            redraw: function() {
                ...
                d.nodes.forEach(function(a) {
                    a.ui && !a.data.redraw ? a.ui.setPosition(a.x, a.y) : (a.ui && (a.ui.removeChildren(), a.ui.remove()), a.ui = that.newGroup(a), l.add(a.ui), a.data.redraw = !1)
                });
                l.draw()
            },
